 ...
 * @LastEditors: PanHan
 * @LastEditTime: 2020-03-03 14:46:27
 * @FilePath: \water_gcc\Src\HardwareProxy\ADS_1256.c
 */
#include "ADS_1256.h"
#include "my_spi.h"
#include "delay.h"
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_Init(AD_CS_GPIO_PORT, &GPIO_InitStruct);
	...
	/*初始化SPI端口*/
//	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;	/* 设为推挽输出口 */
//	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;	/* IO口最大速度 */

//	GPIO_InitStruct.Pin = AD_CLK_PIN;
//	HAL_GPIO_Init(AD_CLK_GPIO_PORT, &GPIO_InitStruct);
